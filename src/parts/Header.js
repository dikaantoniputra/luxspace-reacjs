      ...
      <div className="flex flex-stretch items-center">
        ...
        <div className="w-auto">
          <ul
            ...
            toggleMainMenu ? "opacity- z-30 visible" : "invisible opacity-0",
           ]
          .join("")}
            id="menu"
          >
            ...
            <li className="mx-3 py-6 md:py-0">
            <Link to="/Rewart" className={["hover:underline", theme === "white" ? "text-black md:text-white"  :  "text-white md:text-black", ].join(" ")}> Rewart</Link>
            </li>
          </ul>
        </div>
        <div className="w-auto">
          <ul className="items-center flex">
            <li className="ml-6 block md:hidden">
              ...
              toggleMainMenu ? "fixed top-0 right-0" : "relative",].join(" ")}
